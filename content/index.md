...
<div class="hero">
  ...
  <div class="hero-text">
    ...
    <p class="hero-lead">2,863 works by 13 authors, woven together through shared <em>topoi, archetypes, motifs, themes, forms, settings and characters</em>. Open a work to follow its connections; open a concept to see every work that shares it.</p>
...
The 98 clusters group works by the constellations of theme and form they share. Here are the twelve largest.
